...
?>
    ...
    <head>
        ...
        <link rel="apple-touch-icon" type="image/x-icon" href="<?= APP_URL; ?>/assets/img/apple-touch-icon-57x57-precomposed.png">
        <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="<?= APP_URL; ?>/assets/img/apple-touch-icon-72x72-precomposed.png">
        <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="<?= APP_URL; ?>/assets/img/apple-touch-icon-114x114-precomposed.png">
        <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="<?= APP_URL; ?>/assets/img/apple-touch-icon-144x144-precomposed.png">
        <!-- GOOGLE WEB FONT -->
        ...
        <!-- SPECIFIC CSS -->
        <link href="<?= APP_URL; ?>/assets/css/home.css" rel="stylesheet">
        <!-- YOUR CUSTOM CSS -->
        ...
        <header class="header black_nav clearfix element_to_stick">
            <div class="container">
                ...
                <ul id="top_menu">
                    ...
                    <li class="dropdown">
                        <a class="user-icon dropdown-toggle" data-bs-toggle="dropdown" href="javascript::void(0)" id="navbarDropdownMenuLink">&#xe08a;
                            <?= $user->fname; ?>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li>
                                <a class="dropdown-item" href="<?= APP_URL ?>/logout">Logout</a>
                            </li>
                        </ul>
                ...
                <nav class="main-menu">
                    ...
                    <ul>
                        <li class="submenu">
                            ...
                            <ul>
                                <li>
                                    <a href="index-13.html">KenBurns Slider
                                        <strong>New!</strong>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="index-12.html">Text Rotator
                                        <strong>New!</strong>
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li class="third-level">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="grid-listing-filterscol-map.html">List with map</a>
                                        </li>
                                        <li>
                                            <a href="listing-map.html">List side map</a>
                                        </li>
                                        <li>
                                            <a href="grid-listing-masonry.html">List Masonry Filter</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="third-level">
                                ...
                                <li class="third-level">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="grid-listing-filterscol-openstreetmap.html">List with map</a>
                                        </li>
                                        <li>
                                            <a href="listing-map-openstreetmap.html">List side map</a>
                                        </li>
                                        <li>
                                            <a href="grid-listing-masonry-openstreetmap.html">List Masonry Filter</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
